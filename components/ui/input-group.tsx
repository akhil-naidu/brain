...
const InputGroupControlContext = React.createContext<string | undefined>(undefined);

function InputGroup({ className, ...props }: React.ComponentProps<"fieldset">) {
  const controlId = React.useId();

  return (
    <InputGroupControlContext value={controlId}>
      <fieldset
...
function InputGroupAddon({
  ...
  const controlId = React.use(InputGroupControlContext);
