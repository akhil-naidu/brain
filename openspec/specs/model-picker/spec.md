...
## Purpose
Lets Brain users choose among curated Command Code chat models and visible custom models from the chat UI so each turn can use a faster or stronger model without redeploying the agent.
