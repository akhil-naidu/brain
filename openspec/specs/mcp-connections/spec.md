...
Defines Brain's official MCP connections (ClickUp, Slack, Asana, Gmail, Notion, Linear, Atlassian, Zernio, Sentry, dFlow, GitHub, Snowflake, MongoDB, MCP Toolbox, Rybbit, Bytebot) and how OAuth credentials are obtained for user-scoped tool access without Vercel Connect.
## Requirements
...
- **WHEN** a Snowflake, Toolbox, or Rybbit tool is invoked with a statement containing `DROP TABLE`
