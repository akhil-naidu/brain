...
export async function ensureBrainSchema(pool: Pool): Promise<void> {
  await pool.query(`
    ...
    ALTER TABLE chat ADD COLUMN IF NOT EXISTS pinned_at TEXT;
    ALTER TABLE chat ADD COLUMN IF NOT EXISTS archived_at TEXT;
    ALTER TABLE chat ADD COLUMN IF NOT EXISTS project_id TEXT;
    ...
    CREATE INDEX IF NOT EXISTS chat_project_user_workspace_idx
      ON chat_project (user_id, workspace_id, updated_at DESC);

    CREATE INDEX IF NOT EXISTS chat_project_id_idx ON chat (project_id);
