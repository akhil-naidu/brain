...
description: Deploy Brain on Dokku or dFlow Enterprise with the Dockerfile builder.
---
...
Logical architecture (Postgres, models, live MCP): [Architecture](/docs/self-hosting/architecture).
