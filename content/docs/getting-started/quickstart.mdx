...
description: Short command list to run Brain locally.
---

Run Brain on your machine for development or evaluation.

For the full install (nvm, Git, Docker, `.env`, operator, Ollama, first chat), see **[Local setup](/docs/getting-started/local-setup)**. This page is the short version.
...
2. Sign in → **`/chat`**
3. Continue with [First chat](/docs/getting-started/first-chat) or the rest of [Local setup](/docs/getting-started/local-setup)
